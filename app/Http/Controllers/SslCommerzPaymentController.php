    ...
    public function index(Request $request)
{
    ...
    $validator = Validator::make($request->all(), [
        ...
        $post_data['payment_gateway'] =$request->payment_gateway;
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                return redirect()->route('apply.adminssion')->with('success', 'Your Application is submited. Transaction id is ' . $tran_id);
            }
