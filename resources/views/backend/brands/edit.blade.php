                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                                  data-kt-redirect="" method="POST" action="{{route('brands.update',$brands->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!--begin::Aside column-->
                                        ...
                                        @if($brands->brand_image)
                                            <!--begin::Image input placeholder-->
                                                <style>.image-input-placeholder {
                                                        background-image: url('{{asset(Storage::url('uploads/brands/'.$brands->brand_image))}}');
                                                    }
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <select class="form-select mb-2" data-control="select2"
                                                ...
                                                <option value="1" {{ $brands->status == 1 ? 'selected' : '' }}>
                                                    Published
                                                </option>
                                                <option value="2" {{ $brands->status == 2 ? 'selected' : '' }}>
                                                    Unpublished
                                                </option>
                                            </select>
                                            <!--end::Select2-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <textarea class="form-control" name="shortDescription"  data-kt-autosize="true" placeholder="Short Description">{{$brands->shortDescription}}</textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="">
                                                <!--begin::Input group-->
                                                <label for="basic-url" class="required fw-semibold fs-6 mb-2">URL</label>
                                                <div class="input-group mb-5">
                                                    <span class="input-group-text" id="basic-addon3">example.com</span>
                                                    <input type="text" class="form-control" id="basic-url" name="url" value="{{$brands->url}}" aria-describedby="basic-addon3"/>
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                        </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row" id="kt_ecommerce_add_product_discount_fixed">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="brand_discount" class="form-control mb-2" placeholder="Discounted price" value="{{$brands->brand_discount}}">
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" class="form-control mb-2" name="meta_title"
                                                       placeholder="Meta tag name" value="{{$brands->meta_title}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div>
                                                ...
                                                <input id="kt_ecommerce_add_category_meta_keywords"
                                                       name="meta_title"
                                                       class="form-control mb-2" value="{{$brands->meta_title}}"/>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
...
@push('js')
    ...
    <script>
        ...
        var placeholderText = '{{$brands->meta_descriptions}}';
