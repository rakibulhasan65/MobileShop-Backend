                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        @if ($errors->any())
                            ...
                            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                                  data-kt-redirect="" method="POST" action="{{route('brands.store')}}"
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            ...
                                            <!--end::Image input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Set the Brand thumbnail image. Only *.png,
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <textarea class="form-control" name="shortDescription"
                                                          ...
                                                          placeholder="Short Description">{{old('shortDescription')}}</textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="">
                                                <!--begin::Input group-->
                                                <label for="basic-url" class="required fw-semibold fs-6 mb-2">
                                                    URL</label>
                                                <div class="input-group mb-5">
                                                    ...
                                                    <input type="text" class="form-control" id="basic-url" name="url"
                                                           aria-describedby="basic-addon3" value="{{old('url')}}" />
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                        </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row" id="kt_ecommerce_add_product_discount_fixed">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="brand_discount" class="form-control mb-2"
                                                       placeholder="Discounted price" value="{{old('brand_discount')}}">
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div id="kt_ecommerce_add_category_meta_description"
                                                     ...
                                                     class="min-h-100px mb-2">{{old('meta_descriptions')}}</div>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div>
                                                ...
                                                <input id="kt_ecommerce_add_category_meta_keywords"
                                                       name="meta_title"
                                                       class="form-control mb-2" value="{{old('meta_title')}}" />
                                                <!--end::Editor-->
                                                <!--begin::Description-->
