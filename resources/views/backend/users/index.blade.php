                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                                                   ...
                                                   @csrf
                                                    ...
                                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="password" name="password_confirmation" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="****" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
									...
									<span class="form-check-label fw-semibold text-muted">Status</span>
								</label>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="apps/user-management/users/view.html">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('images/backend') }}/{{ $user->avatar }}" alt="Emma Smith" class="w-100" />
                                                    </div>
                                                </a>
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <form action="{{ route('admin.users.destroy',$user->id) }}"
                                      ...
                                      @csrf()
                                      @method('DELETE')
                                      <button type="submit"  onclick="return confirm('Are your sure?')" class="menu-link px-3"">
