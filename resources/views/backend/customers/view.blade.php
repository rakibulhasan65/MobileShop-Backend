                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <!--end::Menu toggle-->
                            <!--begin::Menu 1-->
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a12155a88bf">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a12155a88bf" data-allow-clear="true">
                                                <option></option>
                                    ...
                                    <div class="card pt-4 mb-6 mb-xl-9">
                                        ...
                                        <div class="card-body pt-0 pb-5">
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14346</a>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14353</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-success">Successful</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14448</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-success">Successful</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15536</a>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14555</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-success">Successful</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15464</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-success">Successful</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15216</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-success">Successful</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15079</a>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15773</a>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-light-warning">Pending</span>
                                                    </td>
                                                            ...
                                                            <div class="flex-equal me-5">
                                                                <table class="table table-flush fw-semibold gy-1">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-gray-800">**** 1358</td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <div class="d-flex flex-wrap py-5">
                                                            ...
                                                            <div class="flex-equal me-5">
                                                                <table class="table table-flush fw-semibold gy-1">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                                                        <td class="text-gray-800">**** 8466</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                                                        ...
                                                        <div class="d-flex flex-wrap py-5">
                                                            ...
                                                            <div class="flex-equal me-5">
                                                                <table class="table table-flush fw-semibold gy-1">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                                                        <td class="text-gray-800">**** 6822</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-muted min-w-125px w-125px">Expires</td>
