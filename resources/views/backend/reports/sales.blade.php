                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <form action="{{ route('reports.sales.filter') }}" method="post">
                                    @csrf

                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="input-group log-event" id="kt_td_picker_linked_1" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="kt_td_picker_linked_1_input" type="text" class="form-control" name="startDate" data-td-target="#kt_td_picker_linked_1"/>
                    ...
                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <div class="input-group log-event" id="kt_td_picker_linked_2" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="kt_td_picker_linked_2_input" type="text" class="form-control" data-td-target="#kt_td_picker_linked_2" name="endDate"/>
                    ...
                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                @foreach($productsSales as $data)
                                    <tr>
                                        <td>{{ \Carbon\Carbon::parse($data->created_at)->format('jS M, Y') }}</td>
