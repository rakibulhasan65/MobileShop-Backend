    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                {{--                                        <!--begin::Input-->--}}
                {{--                                        <div>--}}
                {{--                                            <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a1215280f21" data-allow-clear="true">--}}
                {{--                                                <option></option>--}}
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <form action="{{ route('reports.view.filter') }}" method="post">
                                    @csrf
                    ...
                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                @foreach($productsReports as $data)
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-end pe-0">
                                            <span>{{ $data->view ? $data->view : '0' }}</span>
                                        </td>
                                        <td class="text-end pe-0">24.31%</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
