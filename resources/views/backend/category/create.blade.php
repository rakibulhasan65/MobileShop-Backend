                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        @if ($errors->any())
                            ...
                            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                                  data-kt-redirect="" method="POST" action="{{route('categories.store')}}"
                                ...
                                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="">
                                                <!--begin::Input group-->
                                                <label for="basic-url" class="required fw-semibold fs-6 mb-2">Your
                                                    URL</label>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row" id="kt_ecommerce_add_product_discount_fixed">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="category_discount" class="form-control mb-2"
                                                       placeholder="Discounted price" value="{{old('category_discount')}}">
                                                <!--end::Input-->
                                                <!--begin::Description-->
