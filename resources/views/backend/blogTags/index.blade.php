        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Blogs Tags</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Add customer-->
                                        <a href="{{route('admin.blogtags.create')}}" class="btn btn-primary">Create Blog Tag</a>
                                        <!--end::Add customer-->
                                    </div>
                                    <!--end::Card toolbar-->
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                                <input class="form-check-input checkboxItem"
                                                                       type="checkbox" id="checkbox_{{$data->id}}"
                                                                       value="{{$data->id}}">
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="{{route('admin.blogtags.edit',$data->id)}}"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a class="menu-link px-3 deleteBtn"
                                                                       data-deleteid="{{$data->id}}">Delete</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
        ...
        $(document).on('click', '.deleteBtn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                    const deleteUrl = "{{ route('admin.blogtags.destroy', ['blogtag' => ':deleteId']) }}";
                    const url = deleteUrl.replace(':deleteId', deleteId);
                    $.ajax({
                        url: url,
                        method: "DELETE",
                        data: {
                        ...
                        success: function (response) {
                            ...
                            toastr.success("Blog Tag Successfully Deleted!");
                        },
